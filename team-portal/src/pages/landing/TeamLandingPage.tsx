...
export const TeamLandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070D14] text-slate-100 flex flex-col items-center justify-between p-4 sm:p-6 relative overflow-hidden select-none cursor-default">
      ...
      {/* Spacer where header used to be */}
      <div className="h-4" />
        ...
        <div className="relative w-full max-w-[620px] h-[360px] sm:h-[420px] flex items-center justify-center">
          ...
          >
            <defs>
              ...
              <linearGradient id="orbitInner" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <motion.div
            ...
            className="relative z-20 flex flex-col items-center justify-center text-center p-5 rounded-full bg-[#0B1520]/95 border-2 border-emerald-400/50 shadow-[0_0_50px_rgba(34,197,94,0.4)] backdrop-blur-2xl w-44 h-44 sm:w-52 sm:h-52"
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white p-2 flex items-center justify-center shadow-lg shadow-emerald-950/60 mb-2">
              <img
                src="/logos/gfg_kare_logo.png"
            ...
            <p className="text-[9px] sm:text-[11px] font-mono text-emerald-300/90 font-bold mt-1 tracking-wider uppercase">
              Euphoria 2K26
            </p>
          </motion.div>
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            {clubs.map((club) => {
              ...
              // Oval radii (horizontal rx > vertical ry)
              ...
              const scale = 0.78 + depth * 0.42; // 0.78 at back, 1.2 at front
      ...
      {/* Bottom Enter Button & Made by GEEKS FOR GEEKS Footer */}
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-3 pb-6">
        <motion.button
          ...
          className="w-full py-3.5 px-8 rounded-2xl bg-gradient-to-r from-[#2F8D46] via-[#22C55E] to-[#10B981] text-white text-sm font-bold font-mono tracking-wider flex items-center justify-center gap-2.5 shadow-xl shadow-emerald-950/60 border border-emerald-400/40 cursor-pointer"
        >
          <span>ENTER HACKODYSSEY</span>
