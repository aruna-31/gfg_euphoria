...
export const AdminLoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B131E] text-slate-100 flex flex-col justify-between relative overflow-hidden cyber-mesh">
      ...
      <div className="relative z-10 max-w-md w-full mx-auto p-4 sm:p-6 text-left my-auto">
        <button
          onClick={() => navigate('/')}
        ...
        <div className="bg-[#0F1E2E]/90 border border-cyan-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-cyan-950/80 backdrop-blur-xl">
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-cyan-500/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-cyan-400 font-mono">Hackathon Directorate Console</p>
              </div>
            </div>
            <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded border border-cyan-500/40 text-cyan-300 bg-cyan-950/80">
              ADMIN
            </span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#0B1520] border border-slate-700/60 rounded-xl pl-9 pr-3 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 font-mono"
                />
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full mt-2 bg-gradient-to-r from-cyan-600 to-teal-500 hover:from-cyan-700 hover:to-teal-600 text-white shadow-lg shadow-cyan-950/40"
              rightIcon={<ArrowRight className="w-4 h-4" />}
            >
              {isSubmitting ? 'Authenticating Admin...' : 'Enter Administration Console'}
            </Button>
          </form>
        </div>
      </div>
