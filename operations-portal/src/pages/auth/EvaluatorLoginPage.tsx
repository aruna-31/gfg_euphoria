  ...
  return (
    <div className="min-h-screen bg-[#0B131E] text-slate-100 flex items-center justify-center p-4 relative overflow-hidden cyber-mesh">
      ...
      <div className="relative z-10 max-w-md w-full mx-auto text-left">
        <div className="bg-[#0F1E2E]/95 border border-amber-500/30 rounded-2xl p-7 sm:p-9 shadow-2xl shadow-amber-950/80 backdrop-blur-xl">
          {/* Centered Logo & Header */}
          <div className="flex flex-col items-center justify-center text-center mb-7">
            <div className="w-16 h-16 rounded-2xl bg-white p-2 flex items-center justify-center shadow-lg shadow-amber-950/50 mb-3.5">
              <img
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isSubmitting ? 'Authenticating...' : 'Enter Evaluator Portal'}
            </Button>
          </form>
        </div>
      </div>
