...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 overflow-hidden bg-[#080d0a]/80 backdrop-blur-xl border-b border-[#1b3022] select-none shadow-[0_8px_30px_rgba(0,0,0,0.16)]">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#00d56b] to-[#06391e] flex items-center justify-center p-0.5 shadow-[0_8px_24px_rgba(0,178,89,0.25)]">
